...
public class ModifiedMCTSParams extends PlayerParameters {
    ...
    public int rolloutLength = 12; // assuming we have a good heuristic
    public int maxTreeDepth = 63; // effectively no limit
    ...
    public int reflexiveIterations = 24;
    ...
    public boolean currentRound = true;
    ...
    public ModifiedMCTSParams(long seed) {
        ...
        addTunableParameter("rolloutLength", 12, Arrays.asList(0, 3, 10, 30, 100));
        addTunableParameter("maxTreeDepth", 63, Arrays.asList(1, 3, 10, 30, 100));
        addTunableParameter("epsilon", 1e-6);
        addTunableParameter("heuristic", (IStateHeuristic) AbstractGameState::getHeuristicScore);
        addTunableParameter("reflexiveIterations", 24, Arrays.asList(1, 3, 10, 30, 100));
        addTunableParameter("metamctsCalls", 1, Arrays.asList(1, 2, 3, 4, 5));
        addTunableParameter("reflexiveCalls", 15, Arrays.asList(3, 6, 9, 12, 15));
        addTunableParameter("reflexiveInOpponent", false, Arrays.asList(false, true));
        addTunableParameter("currentRound", true, Arrays.asList(false, true));
    }
